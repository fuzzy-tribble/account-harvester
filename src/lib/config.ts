...
export const accountsMonitor = {
  hfLiquidationTrigger: 1,
  // TODO - COMPLETE
};

// TODO - consider using aave's address provider contract to get latest addresses for all contracts
export const nwProtocols = {
  ethereum: {
    ...
    polygon: {
      topicFilters: null,
      proxyAddress: "0x8dFf5E27EA6b7AC08EbFdf9eB090F32ee9a30fcf",
      lendingPoolAddress: "",
    },
  },
  sushiswap: {},
...
export const dataFiles = {
  ...
  parsedTransactions: "parsed-transactions.json",
  temp: `temp-${Date.now()}`,
};
